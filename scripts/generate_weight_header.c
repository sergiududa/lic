...
int main(int argc, char **argv)
{
    ...
    if(strcmp(argv[i],"conv1_biases.out") == 0)
    {
        n = CONV1_BIAS_SIZE;
        m = 1;
        p = 1;
    ...
    if(strcmp(argv[i],"conv2_biases.out") == 0)
    {
        n = CONV2_BIAS_SIZE;
        m = 1;
        p = 1;
    ...
    if(strcmp(argv[i],"fc1_bias.out") == 0)
    {
        n = FC1_BIAS_SIZE;
        m = 1;
        p = 1;
    ...
    if(strcmp(argv[i],"fc2_bias.out") == 0)
    {
        n = FC2_BIAS_SIZE;
        m = 1;
        p = 1;
    ...
    if(strcmp(argv[i],"fc3_bias.out") == 0)
    {
        n = FC3_BIAS_SIZE;
        m = 1;
        p = 1;
    ...
    if(strcmp(argv[i],"conv1_weights.out") == 0)
    {
        file_type = 2;
    ...
    if(strcmp(argv[i],"conv2_weights.out") == 0)
    {
        file_type = 2;
    ...
    if(strcmp(argv[i],"fc1_weights.out") == 0)
    {
        n = FC1_WEIGHTS_H;
        m = FC1_WEIGHTS_W;
        p = 1;
    ...
    if(strcmp(argv[i],"fc2_weights.out") == 0)
    {
        n = FC2_WEIGHTS_H;
        m = FC2_WEIGHTS_W;
        p = 1;
    ...
    if(strcmp(argv[i],"fc3_weights.out") == 0)
    {
        n = FC3_WEIGHTS_H;
        m = FC3_WEIGHTS_W;
        p = 1;
