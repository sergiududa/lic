set C_TypeInfoList {{ 
"fc" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"output": [[], {"array": [ {"scalar": "float"}, [120]]}] }, {"input": [[], {"array": [ {"scalar": "float"}, [576]]}] }, {"weight": [[], {"array": [ {"array": [ {"scalar": "float"}, [120]]}, [576]]}] }, {"bias": [[], {"array": [ {"scalar": "float"}, [120]]}] }],[],""]
}}
set moduleName fc
...
set C_modelArgList {
	...
	{ weight float 32 regular {array 69120 { 1 3 } 1 1 }  }
	{ bias float 32 regular {array 120 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "output","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 119,"step" : 1}]}]}]} , 
 	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "input","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 575,"step" : 1}]}]}]} , 
 	{ "Name" : "weight", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "weight","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 575,"step" : 1},{"low" : 0,"up" : 119,"step" : 1}]}]}]} , 
 	{ "Name" : "bias", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "bias","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 119,"step" : 1}]}]}]} ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fc_fadd_32ns_32nsbkb_U1", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fc_fmul_32ns_32nscud_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fc_fcmp_32ns_32nsdEe_U3", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "761521", "Max" : "761521"}
	, {"Name" : "Interval", "Min" : "761522", "Max" : "761522"}
]}
