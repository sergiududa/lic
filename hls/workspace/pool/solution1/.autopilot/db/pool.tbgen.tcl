...
set portList { 
	...
	{ output_r_address1 sc_out sc_lv 11 signal 0 } 
	...
	{ image_r_d0 sc_out sc_lv 32 signal 1 } 
	...
	{ image_r_d1 sc_out sc_lv 32 signal 1 } 
	{ image_r_q1 sc_in sc_lv 32 signal 1 } 
	{ image_r_we1 sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "output_r_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "output_r", "role": "address0" }} , 
 	...
 	{ "name": "output_r_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "output_r", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"VariableLatency" : "1",
		"InputProcess" : [
			{"ID" : "1", "Name" : "Loop_pool_label2_pro_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "Loop_pool_label2_pro_U0"}],
		"Port" : [
			{"Name" : "output_r", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "Loop_pool_label2_pro_U0", "Port" : "output_r"}]},
			{"Name" : "image_r", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "Loop_pool_label2_pro_U0", "Port" : "image_r"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_pool_label2_pro_U0", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "Loop_pool_label2_pro",
		...
		"Port" : [
			{"Name" : "output_r", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "image_r", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_pool_label2_pro_U0.pool_fcmp_32ns_32bkb_U1", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 11 }  { output_r_ce0 mem_ce 1 1 }  { output_r_d0 mem_din 1 32 }  { output_r_q0 mem_dout 0 32 }  { output_r_we0 mem_we 1 1 }  { output_r_address1 mem_address 1 11 }  { output_r_ce1 mem_ce 1 1 }  { output_r_d1 mem_din 1 32 }  { output_r_q1 mem_dout 0 32 }  { output_r_we1 mem_we 1 1 } } }
	image_r { ap_memory {  { image_r_address0 mem_address 1 13 }  { image_r_ce0 mem_ce 1 1 }  { image_r_d0 mem_din 1 32 }  { image_r_q0 mem_dout 0 32 }  { image_r_we0 mem_we 1 1 }  { image_r_address1 mem_address 1 13 }  { image_r_ce1 mem_ce 1 1 }  { image_r_d1 mem_din 1 32 }  { image_r_q1 mem_dout 0 32 }  { image_r_we1 mem_we 1 1 } } }
}
