...
entity conv_layer1_conv_cud_ram is 
    generic(
...
architecture rtl of conv_layer1_conv_cud_ram is 
...
architecture arch of conv_layer1_conv_cud is
    component conv_layer1_conv_cud_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    conv_layer1_conv_cud_ram_U :  component conv_layer1_conv_cud_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
