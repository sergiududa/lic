...
#ifndef __nnet_mul_mul_16s_bPq__HH__
#define __nnet_mul_mul_16s_bPq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_16s_bPq) {
    ...
    SC_CTOR(nnet_mul_mul_16s_bPq):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
