...
#ifndef __nnet_mul_mul_16s_bOq__HH__
#define __nnet_mul_mul_16s_bOq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_16s_bOq) {
    ...
    SC_CTOR(nnet_mul_mul_16s_bOq):  ACMP_smul_su_U ("ACMP_smul_su_U") {
