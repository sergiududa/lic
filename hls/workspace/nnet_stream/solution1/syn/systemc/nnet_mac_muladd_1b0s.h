...
#ifndef __nnet_mac_muladd_1b0s__HH__
#define __nnet_mac_muladd_1b0s__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1b0s) {
    ...
    SC_CTOR(nnet_mac_muladd_1b0s):  simcore_mac_8_U ("simcore_mac_8_U") {
