...
#ifndef __nnet_mac_muladd_1b2s__HH__
#define __nnet_mac_muladd_1b2s__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1b2s) {
    ...
    SC_CTOR(nnet_mac_muladd_1b2s):  simcore_mac_10_U ("simcore_mac_10_U") {
