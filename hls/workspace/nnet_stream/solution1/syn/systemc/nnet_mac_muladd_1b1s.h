...
#ifndef __nnet_mac_muladd_1b1s__HH__
#define __nnet_mac_muladd_1b1s__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1b1s) {
    ...
    SC_CTOR(nnet_mac_muladd_1b1s):  simcore_mac_9_U ("simcore_mac_9_U") {
