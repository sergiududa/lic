...
#ifndef __nnet_mul_mul_16s_bRq__HH__
#define __nnet_mul_mul_16s_bRq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_16s_bRq) {
    ...
    SC_CTOR(nnet_mul_mul_16s_bRq):  ACMP_smul_su_U ("ACMP_smul_su_U") {
