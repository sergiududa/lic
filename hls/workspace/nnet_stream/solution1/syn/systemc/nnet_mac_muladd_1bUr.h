...
#ifndef __nnet_mac_muladd_1bUr__HH__
#define __nnet_mac_muladd_1bUr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1bUr) {
    ...
    SC_CTOR(nnet_mac_muladd_1bUr):  simcore_mac_2_U ("simcore_mac_2_U") {
