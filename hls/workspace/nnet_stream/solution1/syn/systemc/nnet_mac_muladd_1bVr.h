...
#ifndef __nnet_mac_muladd_1bVr__HH__
#define __nnet_mac_muladd_1bVr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1bVr) {
    ...
    SC_CTOR(nnet_mac_muladd_1bVr):  simcore_mac_3_U ("simcore_mac_3_U") {
