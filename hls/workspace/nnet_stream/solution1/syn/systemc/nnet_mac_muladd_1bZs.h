...
#ifndef __nnet_mac_muladd_1bZs__HH__
#define __nnet_mac_muladd_1bZs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1bZs) {
    ...
    SC_CTOR(nnet_mac_muladd_1bZs):  simcore_mac_7_U ("simcore_mac_7_U") {
