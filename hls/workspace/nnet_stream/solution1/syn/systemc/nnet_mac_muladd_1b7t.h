...
#ifndef __nnet_mac_muladd_1b7t__HH__
#define __nnet_mac_muladd_1b7t__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1b7t) {
    ...
    SC_CTOR(nnet_mac_muladd_1b7t):  simcore_mac_15_U ("simcore_mac_15_U") {
