...
#ifndef __nnet_mac_muladd_1bWr__HH__
#define __nnet_mac_muladd_1bWr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1bWr) {
    ...
    SC_CTOR(nnet_mac_muladd_1bWr):  simcore_mac_4_U ("simcore_mac_4_U") {
