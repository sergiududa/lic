...
#ifndef __nnet_mac_muladd_1bYs__HH__
#define __nnet_mac_muladd_1bYs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1bYs) {
    ...
    SC_CTOR(nnet_mac_muladd_1bYs):  simcore_mac_6_U ("simcore_mac_6_U") {
