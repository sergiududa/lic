...
#ifndef __nnet_mac_muladd_1bXr__HH__
#define __nnet_mac_muladd_1bXr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1bXr) {
    ...
    SC_CTOR(nnet_mac_muladd_1bXr):  simcore_mac_5_U ("simcore_mac_5_U") {
