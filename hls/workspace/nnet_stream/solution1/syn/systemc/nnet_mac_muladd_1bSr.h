...
#ifndef __nnet_mac_muladd_1bSr__HH__
#define __nnet_mac_muladd_1bSr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_1bSr) {
    ...
    SC_CTOR(nnet_mac_muladd_1bSr):  simcore_mac_0_U ("simcore_mac_0_U") {
