...
entity Loop_1_proc138_imbkb_rom is 
    generic(
             dwidth     : integer := 12; 
             awidth     : integer := 10; 
...
architecture rtl of Loop_1_proc138_imbkb_rom is 
...
entity Loop_1_proc138_imbkb is
    generic (
...
architecture arch of Loop_1_proc138_imbkb is
    component Loop_1_proc138_imbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Loop_1_proc138_imbkb_rom_U :  component Loop_1_proc138_imbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
