...
#ifndef __nnet_mul_mul_24s_4jc__HH__
#define __nnet_mul_mul_24s_4jc__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_24s_4jc) {
    ...
    SC_CTOR(nnet_mul_mul_24s_4jc):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
