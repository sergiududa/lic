...
#ifndef __nnet_mul_mul_19s_0iy__HH__
#define __nnet_mul_mul_19s_0iy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_19s_0iy) {
    ...
    SC_CTOR(nnet_mul_mul_19s_0iy):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
