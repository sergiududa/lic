...
#ifndef __nnet_mul_mul_19s_sc4__HH__
#define __nnet_mul_mul_19s_sc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_19s_sc4) {
    ...
    SC_CTOR(nnet_mul_mul_19s_sc4):  ACMP_smul_su_U ("ACMP_smul_su_U") {
