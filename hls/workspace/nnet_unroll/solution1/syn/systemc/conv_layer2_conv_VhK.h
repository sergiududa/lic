...
#ifndef __conv_layer2_conv_VhK_H__
#define __conv_layer2_conv_VhK_H__
...
struct conv_layer2_conv_VhK_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(conv_layer2_conv_VhK_ram) {
...
SC_MODULE(conv_layer2_conv_VhK) {
...
conv_layer2_conv_VhK_ram* meminst;


SC_CTOR(conv_layer2_conv_VhK) {
meminst = new conv_layer2_conv_VhK_ram("conv_layer2_conv_VhK_ram");
