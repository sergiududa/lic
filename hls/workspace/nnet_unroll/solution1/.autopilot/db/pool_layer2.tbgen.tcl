...
set C_modelName {pool_layer2}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_V int 24 regular {array 576 { 0 0 } 0 1 }  }
	{ image_V int 24 regular {array 2704 { 1 1 } 1 1 }  }
}
...
set portList { 
	...
	{ output_V_address1 sc_out sc_lv 10 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "output_V", "role": "address1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3001", "Max" : "3096"}
	, {"Name" : "Interval", "Min" : "3001", "Max" : "3096"}
]}
...
set Spec2ImplPortList { 
	output_V { ap_memory {  { output_V_address0 mem_address 1 10 }  { output_V_ce0 mem_ce 1 1 }  { output_V_we0 mem_we 1 1 }  { output_V_d0 mem_din 1 24 }  { output_V_address1 mem_address 1 10 }  { output_V_ce1 mem_ce 1 1 }  { output_V_we1 mem_we 1 1 }  { output_V_d1 mem_din 1 24 } } }
	image_V { ap_memory {  { image_V_address0 mem_address 1 12 }  { image_V_ce0 mem_ce 1 1 }  { image_V_q0 mem_dout 0 24 }  { image_V_address1 mem_address 1 12 }  { image_V_ce1 mem_ce 1 1 }  { image_V_q1 mem_dout 0 24 } } }
}
