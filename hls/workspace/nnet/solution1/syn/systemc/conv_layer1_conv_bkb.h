...
#ifndef __conv_layer1_conv_bkb_H__
#define __conv_layer1_conv_bkb_H__
...
conv_layer1_conv_bkb_ram* meminst;


SC_CTOR(conv_layer1_conv_bkb) {
meminst = new conv_layer1_conv_bkb_ram("conv_layer1_conv_bkb_ram");
