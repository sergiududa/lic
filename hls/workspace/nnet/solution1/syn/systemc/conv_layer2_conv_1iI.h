...
#ifndef __conv_layer2_conv_1iI_H__
#define __conv_layer2_conv_1iI_H__
...
struct conv_layer2_conv_1iI_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(conv_layer2_conv_1iI_ram) {
...
SC_MODULE(conv_layer2_conv_1iI) {
...
conv_layer2_conv_1iI_ram* meminst;


SC_CTOR(conv_layer2_conv_1iI) {
meminst = new conv_layer2_conv_1iI_ram("conv_layer2_conv_1iI_ram");
