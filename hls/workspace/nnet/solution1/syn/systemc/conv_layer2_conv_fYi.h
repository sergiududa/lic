...
#ifndef __conv_layer2_conv_fYi_H__
#define __conv_layer2_conv_fYi_H__
...
struct conv_layer2_conv_fYi_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(conv_layer2_conv_fYi_ram) {
...
SC_MODULE(conv_layer2_conv_fYi) {
...
conv_layer2_conv_fYi_ram* meminst;


SC_CTOR(conv_layer2_conv_fYi) {
meminst = new conv_layer2_conv_fYi_ram("conv_layer2_conv_fYi_ram");
