...
#ifndef __nnet_mul_mul_19s_tde__HH__
#define __nnet_mul_mul_19s_tde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_19s_tde) {
    ...
    SC_CTOR(nnet_mul_mul_19s_tde):  ACMP_smul_su_U ("ACMP_smul_su_U") {
