...
#ifndef __nnet_mul_mul_24s_8jQ__HH__
#define __nnet_mul_mul_24s_8jQ__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_24s_8jQ) {
    ...
    SC_CTOR(nnet_mul_mul_24s_8jQ):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
