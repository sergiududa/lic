...
#ifndef __nnet_mul_mul_24s_7jG__HH__
#define __nnet_mul_mul_24s_7jG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_24s_7jG) {
    ...
    SC_CTOR(nnet_mul_mul_24s_7jG):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
