...
#ifndef __nnet_mul_mul_19s_3i2__HH__
#define __nnet_mul_mul_19s_3i2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_19s_3i2) {
    ...
    SC_CTOR(nnet_mul_mul_19s_3i2):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
