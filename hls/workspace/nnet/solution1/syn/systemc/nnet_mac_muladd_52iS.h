...
#ifndef __nnet_mac_muladd_52iS__HH__
#define __nnet_mac_muladd_52iS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_52iS) {
    ...
    SC_CTOR(nnet_mac_muladd_52iS):  simcore_mac_1_U ("simcore_mac_1_U") {
