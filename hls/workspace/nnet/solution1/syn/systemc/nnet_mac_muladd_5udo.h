...
#ifndef __nnet_mac_muladd_5udo__HH__
#define __nnet_mac_muladd_5udo__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_5udo) {
    ...
    SC_CTOR(nnet_mac_muladd_5udo):  simcore_mac_0_U ("simcore_mac_0_U") {
