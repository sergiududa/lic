...
entity conv_layer2_conv_0iy_rom is 
    generic(
             dwidth     : integer := 19; 
             awidth     : integer := 4; 
             mem_size    : integer := 16
...
architecture rtl of conv_layer2_conv_0iy_rom is 
...
entity conv_layer2_conv_0iy is
    generic (
...
architecture arch of conv_layer2_conv_0iy is
    component conv_layer2_conv_0iy_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    conv_layer2_conv_0iy_rom_U :  component conv_layer2_conv_0iy_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
