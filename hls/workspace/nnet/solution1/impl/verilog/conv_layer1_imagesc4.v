...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module conv_layer1_imagesc4_rom (
...
initial begin
    $readmemh("./conv_layer1_imagesc4_rom.dat", ram0);
    $readmemh("./conv_layer1_imagesc4_rom.dat", ram1);
    $readmemh("./conv_layer1_imagesc4_rom.dat", ram2);
    $readmemh("./conv_layer1_imagesc4_rom.dat", ram3);
    $readmemh("./conv_layer1_imagesc4_rom.dat", ram4);
    $readmemh("./conv_layer1_imagesc4_rom.dat", ram5);
    $readmemh("./conv_layer1_imagesc4_rom.dat", ram6);
    $readmemh("./conv_layer1_imagesc4_rom.dat", ram7);
end
...
conv_layer1_imagesc4_rom conv_layer1_imagesc4_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
