...
set C_modelArgList {
	...
	{ image_r float 32 regular {array 6728 { 1 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.nnet_fcmp_32ns_32fYi_U11", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "42577", "Max" : "42577"}
	, {"Name" : "Interval", "Min" : "42577", "Max" : "42577"}
]}
...
set Spec2ImplPortList { 
	...
	image_r { ap_memory {  { image_r_address0 mem_address 1 13 }  { image_r_ce0 mem_ce 1 1 }  { image_r_q0 mem_dout 0 32 } } }
}
