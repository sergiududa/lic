...
set C_modelArgList {
	...
	{ image_V int 24 regular {array 1568 { 1 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_layer2_bias_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.conv_layer2_weights_s_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.nnet_mul_mul_24s_hbi_U9", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "387137", "Max" : "387137"}
	, {"Name" : "Interval", "Min" : "387137", "Max" : "387137"}
]}
...
set Spec2ImplPortList { 
	...
	image_V { ap_memory {  { image_V_address0 mem_address 1 11 }  { image_V_ce0 mem_ce 1 1 }  { image_V_q0 mem_dout 0 24 } } }
}
